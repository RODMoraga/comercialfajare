...
<html lang="en">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                <div class="box-header with-border">
                                    <h1 class="box-title text-capitalize text-maroon" style="font-size: 3rem; text-shadow: 1px 1px 2px black;">maestra unidad de medida&nbsp;&nbsp;&nbsp;
                                        <button class="btn btn-success flat" id="btnadd" data-toggle="modal" data-target="#bankModal" style="border-radius: .7rem;"><i class="fa fa-plus-circle"></i>&nbsp;&nbsp;&nbsp;Agregar Registro</button>
                                    </h1>
                                ...
                                <div class="panel-body table-responsive">
                                    <table id="tbluom" class="table table-striped table-bordered table-condensed table-hover" style="width:100%">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header bg-green-gradient">
                                                    <h5 class="modal-title">Módulo Unidad de Medida</h5>
        ...
        <script src="src/ajax/uom.js"></script>
    </body>
</html>
<?php
    } // Cierre if
